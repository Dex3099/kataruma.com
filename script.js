...
async function updateDiscordStatus() {
    try {
        const response = await fetch(`https://api.lanyard.rest/v1/users/786314481554292756`);
        ...
        console.log('Error retrieving Discord data:', error);
    }
}
...
async function updateSpotifyStatus() {
    try {
        ...
        console.log('Error retrieving Spotify data:', error);
        updateSpotifyUI(null);
    }
}
